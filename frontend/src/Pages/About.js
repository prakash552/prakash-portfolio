    ...
    <div className="about-container">
      ...
      <section className="journey">
        ...
        <ul>
          ...
          <li>🔥 Built multiple MERN Stack projects in 2024</li>
          <li>💡 Currently building real-world e-commerce & product-based apps</li>
        </ul>
      </section>
      ...
      <section className="fun-facts">
        <h2>Fun Facts</h2>
        <p>🎮 Gamer at heart | 💻 Code + Coffee lover | ✈️ Dreaming to work with a global team</p>
      </section>
